...
{
    public class RoomCombinationHotelbedsAlternative : IRoomDedupeCombination<Rate>
    {
        private readonly SortedDictionary<int, List<RoomData<Rate>>> _data;

        public RoomCombinationHotelbedsAlternative() => this._data = new SortedDictionary<int, List<RoomData<Rate>>>();
